...
namespace TouchScript.InputSources.InputHandlers
{
    ...
    public abstract class WindowsPointerHandler : IInputSource, IDisposable
    {
        ...
        private static WindowsPointerHandler ins;
        ...
        [MonoPInvokeCallback]
        private static void nativePointer(int id, PointerEvent evt, PointerType type, Vector2 position, PointerData data)
        {
            switch (type)
            {
                case PointerType.Mouse:
                    switch (evt)
                    {
                        ...
                        case PointerEvent.Down:
                            ins.mousePointer.Buttons = ins.updateButtons(ins.mousePointer.Buttons, data.PointerFlags, data.ChangedButtons);
                            ins.pressPointer(ins.mousePointer);
                            break;
                        case PointerEvent.Up:
                            ins.mousePointer.Buttons = ins.updateButtons(ins.mousePointer.Buttons, data.PointerFlags, data.ChangedButtons);
                            ins.releasePointer(ins.mousePointer);
                            break;
                        case PointerEvent.Update:
                            ins.mousePointer.Position = position;
                            ins.mousePointer.Buttons = ins.updateButtons(ins.mousePointer.Buttons, data.PointerFlags, data.ChangedButtons);
                            ins.updatePointer(ins.mousePointer);
                            break;
                        case PointerEvent.Cancelled:
                            ins.cancelPointer(ins.mousePointer);
                            // can't cancel the mouse pointer, it is always present
                            ins.mousePointer = ins.internalAddMousePointer(ins.mousePointer.Position);
                            break;
                    }
                    break;
                case PointerType.Touch:
                    ...
                    switch (evt)
                    {
                        ...
                        case PointerEvent.Leave:
                            ...
                            if (ins.winTouchToInternalId.TryGetValue(id, out touchPointer))
                            {
                                ins.winTouchToInternalId.Remove(id);
                                ins.internalRemoveTouchPointer(touchPointer);
                            }
                            break;
                        case PointerEvent.Down:
                            touchPointer = ins.internalAddTouchPointer(position);
                            touchPointer.Rotation = ins.getTouchRotation(ref data);
                            touchPointer.Pressure = ins.getTouchPressure(ref data);
                            ins.winTouchToInternalId.Add(id, touchPointer);
                            break;
                        case PointerEvent.Up:
                            break;
                        case PointerEvent.Update:
                            if (!ins.winTouchToInternalId.TryGetValue(id, out touchPointer)) return;
                            touchPointer.Position = position;
                            touchPointer.Rotation = ins.getTouchRotation(ref data);
                            touchPointer.Pressure = ins.getTouchPressure(ref data);
                            ins.updatePointer(touchPointer);
                            break;
                        case PointerEvent.Cancelled:
                            if (ins.winTouchToInternalId.TryGetValue(id, out touchPointer))
                            {
                                ins.winTouchToInternalId.Remove(id);
                                ins.cancelPointer(touchPointer);
                            }
                            break;
                    }
                    break;
                case PointerType.Pen:
                    ...
                    {
                        case PointerEvent.Enter:
                            ins.penPointer = ins.internalAddPenPointer(position);
                            ins.penPointer.Pressure = ins.getPenPressure(ref data);
                            ins.penPointer.Rotation = ins.getPenRotation(ref data);
                            break;
                        case PointerEvent.Leave:
                            if (ins.penPointer == null) break;
                            ins.internalRemovePenPointer(ins.penPointer);
                            break;
                        case PointerEvent.Down:
                            if (ins.penPointer == null) break;
                            ins.penPointer.Buttons = ins.updateButtons(ins.penPointer.Buttons, data.PointerFlags, data.ChangedButtons);
                            ins.penPointer.Pressure = ins.getPenPressure(ref data);
                            ins.penPointer.Rotation = ins.getPenRotation(ref data);
                            ins.pressPointer(ins.penPointer);
                            break;
                        case PointerEvent.Up:
                            if (ins.penPointer == null) break;
                            ins.mousePointer.Buttons = ins.updateButtons(ins.penPointer.Buttons, data.PointerFlags, data.ChangedButtons);
                            ins.releasePointer(ins.penPointer);
                            break;
                        case PointerEvent.Update:
                            if (ins.penPointer == null) break;
                            ins.penPointer.Position = position;
                            ins.penPointer.Pressure = ins.getPenPressure(ref data);
                            ins.penPointer.Rotation = ins.getPenRotation(ref data);
                            ins.penPointer.Buttons = ins.updateButtons(ins.penPointer.Buttons, data.PointerFlags, data.ChangedButtons);
                            ins.updatePointer(ins.penPointer);
                            break;
                        case PointerEvent.Cancelled:
                            if (ins.penPointer == null) break;
                            ins.cancelPointer(ins.penPointer);
                            break;
                    }
                    break;
            }
