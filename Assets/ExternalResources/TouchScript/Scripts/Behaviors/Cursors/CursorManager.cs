...
namespace TouchScript.Behaviors.Cursors
{
    ...
    public class CursorManager : MonoBehaviour
    {
        ...
        private Dictionary<int, PointerCursor> cursors = new Dictionary<int, PointerCursor>(150);
        ...
        private void Awake()
        {
            ...
            touchPool = new ObjectPool<PointerCursor>(2, instantiateTouchProxy, null, clearProxy);
